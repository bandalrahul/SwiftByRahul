...
extension Theme where Site == SwiftByRahul {
...
try SwiftByRahul().publish(using: [
    .addMarkdownFiles(),
    .copyResources(),
    .generateHTML(withTheme: .myTheme), // Using your custom theme
    .deploy(using: .gitHub("bandalrahul/SwiftByRahul", branch: "main"))
])
